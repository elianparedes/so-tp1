...
/**
 * @brief cierra los descriptores de archivos de los 3 pipes y termina la ejecución del programa en caso de error
 * 
 */
 ...
 * @return int descriptor de archivo de la memoria compartida. ERROR_CODE si hubo un error.
 */
 ...
 * @param slave_to_master_stdout matriz de pipes que comunican la salida estandar de slave con app
 * @param slave_to_master_stderr matriz de pipes que comunican la salida de error de slave con app
...
/**
 * @brief ejecuta el programa SLAVE_NAME, conectando los pipes para que se puedan comunicar el proceso padre con el hijo. En caso de error,
 * abortará el programa
 * 
 * @param master_to_slave matriz que contiene el pipe que comunica su descriptor de lectura con la entrada estándar del proceso hijo
 * @param slave_to_master_stdout matriz que contiene el pipe que comunica su descriptor de lectura con la salida estándar del proceso hijo
 * @param slave_to_master_stderr matriz que contiene el pipe que comunica su descriptor de lectura con la salida de error del proceso hijo
 * @param index índice de la matriz que indica los pipes que serán conectados
 * @param count en caso de error, esta variable es requerida para cerrar todos los descriptores de los pipes
 */
